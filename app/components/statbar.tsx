...
export default function Statbar({ raw, accuracy, mode,consistency }: Statbarprop) {
  ...
  return (
    <div className="text-[var(--resStatTextColor)] border-2 border-[var(--border-color)] text-2xl flex w-300 text-center justify-center gap-[240px] mx-auto bg-[var(--resStatBoxColor)] rounded-lg pt-4 pb-4 shadow-lg mt-4">
      <div>
        raw
